...
class OSWAP_OracleRouter extends eth_wallet_1.Contract {
    ...
    async swapETHForExactTokens(params, _value) {
        let result = await this.methods('swapETHForExactTokens', eth_wallet_1.Utils.toString(params.amountOut), params.path, params.to, eth_wallet_1.Utils.toString(params.deadline), params.useOracle, params.data, _value);
        return result;
    }
    async swapExactETHForTokens(params, _value) {
        let result = await this.methods('swapExactETHForTokens', eth_wallet_1.Utils.toString(params.amountOutMin), params.path, params.to, eth_wallet_1.Utils.toString(params.deadline), params.useOracle, params.data, _value);
        return result;
    }
    async swapExactETHForTokensSupportingFeeOnTransferTokens(params, _value) {
        let result = await this.methods('swapExactETHForTokensSupportingFeeOnTransferTokens', eth_wallet_1.Utils.toString(params.amountOutMin), params.path, params.to, eth_wallet_1.Utils.toString(params.deadline), params.useOracle, params.data, _value);
        return result;
    }
