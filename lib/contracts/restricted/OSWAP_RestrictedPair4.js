...
class OSWAP_RestrictedPair4 extends eth_contract_1.Contract {
    ...
    assign() {
        ...
        let lastTraderAllocation_call = async (params) => {
        ...
        let offerAllowlistIpfsCid_call = async (params) => {
        ...
        let offerMerkleRoot_call = async (params) => {
        ...
        let setApprovedTraderByMerkleProof_send = async (params) => {
            let result = await this.send('setApprovedTraderByMerkleProof', setApprovedTraderByMerkleProofParams(params));
            return result;
        };
        let setApprovedTraderByMerkleProof_call = async (params) => {
        ...
        let setMerkleRoot_send = async (params) => {
            let result = await this.send('setMerkleRoot', setMerkleRootParams(params));
            return result;
        };
        let setMerkleRoot_call = async (params) => {
