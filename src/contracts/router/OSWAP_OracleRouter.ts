...
export class OSWAP_OracleRouter extends Contract{
    ...
    async getAmountIn(params:{amountOut:number|BigNumber,tokenIn:string,tokenOut:string,data:string}): Promise<BigNumber>{
        let result = await this.call('getAmountIn',[Utils.toString(params.amountOut),params.tokenIn,params.tokenOut,Utils.stringToBytes(params.data)]);
        return new BigNumber(result);
    }
    async getAmountOut(params:{amountIn:number|BigNumber,tokenIn:string,tokenOut:string,data:string}): Promise<BigNumber>{
        let result = await this.call('getAmountOut',[Utils.toString(params.amountIn),params.tokenIn,params.tokenOut,Utils.stringToBytes(params.data)]);
        return new BigNumber(result);
    }
    async getAmountsIn(params:{amountOut:number|BigNumber,path:string[],useOracle:boolean[],data:string}): Promise<BigNumber[]>{
        let result = await this.call('getAmountsIn',[Utils.toString(params.amountOut),params.path,params.useOracle,Utils.stringToBytes(params.data)]);
    ...
    async getAmountsOut(params:{amountIn:number|BigNumber,path:string[],useOracle:boolean[],data:string}): Promise<BigNumber[]>{
        let result = await this.call('getAmountsOut',[Utils.toString(params.amountIn),params.path,params.useOracle,Utils.stringToBytes(params.data)]);
        return result.map(e=>new BigNumber(e));
    }
    async getLatestPrice(params:{tokenIn:string,tokenOut:string,data:string}): Promise<BigNumber>{
        let result = await this.call('getLatestPrice',[params.tokenIn,params.tokenOut,Utils.stringToBytes(params.data)]);
        return new BigNumber(result);
    }
    ...
    async swapETHForExactTokens_send(params:{amountOut:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string},_value:number|BigNumber): Promise<TransactionReceipt>{
        let result = await this.send('swapETHForExactTokens',[Utils.toString(params.amountOut),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)], {value:_value});
        return result;
    }
    async swapETHForExactTokens_call(params:{amountOut:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string},_value:number|BigNumber): Promise<BigNumber[]>{
        let result = await this.call('swapETHForExactTokens',[Utils.toString(params.amountOut),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)], {value:_value});
        return result.map(e=>new BigNumber(e));
    }
    ...
    async swapExactETHForTokens_send(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string},_value:number|BigNumber): Promise<TransactionReceipt>{
        let result = await this.send('swapExactETHForTokens',[Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)], {value:_value});
        return result;
    }
    async swapExactETHForTokens_call(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string},_value:number|BigNumber): Promise<BigNumber[]>{
        let result = await this.call('swapExactETHForTokens',[Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)], {value:_value});
        return result.map(e=>new BigNumber(e));
    }
    ...
    async swapExactETHForTokensSupportingFeeOnTransferTokens_send(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string},_value:number|BigNumber): Promise<TransactionReceipt>{
        let result = await this.send('swapExactETHForTokensSupportingFeeOnTransferTokens',[Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)], {value:_value});
        return result;
    }
    async swapExactETHForTokensSupportingFeeOnTransferTokens_call(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string},_value:number|BigNumber): Promise<void>{
        let result = await this.call('swapExactETHForTokensSupportingFeeOnTransferTokens',[Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)], {value:_value});
        return;
    }
    ...
    async swapExactTokensForETH_send(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<TransactionReceipt>{
        let result = await this.send('swapExactTokensForETH',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result;
    }
    async swapExactTokensForETH_call(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<BigNumber[]>{
        let result = await this.call('swapExactTokensForETH',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result.map(e=>new BigNumber(e));
    }
    ...
    async swapExactTokensForETHSupportingFeeOnTransferTokens_send(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<TransactionReceipt>{
        let result = await this.send('swapExactTokensForETHSupportingFeeOnTransferTokens',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result;
    }
    async swapExactTokensForETHSupportingFeeOnTransferTokens_call(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<void>{
        let result = await this.call('swapExactTokensForETHSupportingFeeOnTransferTokens',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return;
    }
    ...
    async swapExactTokensForTokens_send(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<TransactionReceipt>{
        let result = await this.send('swapExactTokensForTokens',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result;
    }
    async swapExactTokensForTokens_call(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<BigNumber[]>{
        let result = await this.call('swapExactTokensForTokens',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result.map(e=>new BigNumber(e));
    }
    ...
    async swapExactTokensForTokensSupportingFeeOnTransferTokens_send(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<TransactionReceipt>{
        let result = await this.send('swapExactTokensForTokensSupportingFeeOnTransferTokens',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result;
    }
    async swapExactTokensForTokensSupportingFeeOnTransferTokens_call(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<void>{
        let result = await this.call('swapExactTokensForTokensSupportingFeeOnTransferTokens',[Utils.toString(params.amountIn),Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return;
    }
    ...
    async swapTokensForExactETH_send(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<TransactionReceipt>{
        let result = await this.send('swapTokensForExactETH',[Utils.toString(params.amountOut),Utils.toString(params.amountInMax),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result;
    }
    async swapTokensForExactETH_call(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<BigNumber[]>{
        let result = await this.call('swapTokensForExactETH',[Utils.toString(params.amountOut),Utils.toString(params.amountInMax),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result.map(e=>new BigNumber(e));
    }
    ...
    async swapTokensForExactTokens_send(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<TransactionReceipt>{
        let result = await this.send('swapTokensForExactTokens',[Utils.toString(params.amountOut),Utils.toString(params.amountInMax),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result;
    }
    async swapTokensForExactTokens_call(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,useOracle:boolean[],data:string}): Promise<BigNumber[]>{
        let result = await this.call('swapTokensForExactTokens',[Utils.toString(params.amountOut),Utils.toString(params.amountInMax),params.path,params.to,Utils.toString(params.deadline),params.useOracle,Utils.stringToBytes(params.data)]);
        return result.map(e=>new BigNumber(e));
    }
