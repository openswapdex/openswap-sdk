...
export class OSWAP_Router extends Contract{
    ...
    async addLiquidity(params:{tokenA:string,tokenB:string,amountADesired:number|BigNumber,amountBDesired:number|BigNumber,amountAMin:number|BigNumber,amountBMin:number|BigNumber,to:string,deadline:number|BigNumber}): Promise<{amountA:BigNumber,amountB:BigNumber,liquidity:BigNumber}>{
    ...
    async addLiquidityETH(params:{token:string,amountTokenDesired:number|BigNumber,amountTokenMin:number|BigNumber,amountETHMin:number|BigNumber,to:string,deadline:number|BigNumber}): Promise<{amountToken:BigNumber,amountETH:BigNumber,liquidity:BigNumber}>{
        let result = await this.methods('addLiquidityETH',params.token,Utils.toString(params.amountTokenDesired),Utils.toString(params.amountTokenMin),Utils.toString(params.amountETHMin),params.to,Utils.toString(params.deadline));
        return {
    ...
    async removeLiquidity(params:{tokenA:string,tokenB:string,liquidity:number|BigNumber,amountAMin:number|BigNumber,amountBMin:number|BigNumber,to:string,deadline:number|BigNumber}): Promise<{amountA:BigNumber,amountB:BigNumber}>{
    ...
    async removeLiquidityETH(params:{token:string,liquidity:number|BigNumber,amountTokenMin:number|BigNumber,amountETHMin:number|BigNumber,to:string,deadline:number|BigNumber}): Promise<{amountToken:BigNumber,amountETH:BigNumber}>{
    ...
    async removeLiquidityETHSupportingFeeOnTransferTokens(params:{token:string,liquidity:number|BigNumber,amountTokenMin:number|BigNumber,amountETHMin:number|BigNumber,to:string,deadline:number|BigNumber}): Promise<BigNumber>{
    ...
    async removeLiquidityETHWithPermit(params:{token:string,liquidity:number|BigNumber,amountTokenMin:number|BigNumber,amountETHMin:number|BigNumber,to:string,deadline:number|BigNumber,approveMax:boolean,v:number|BigNumber,r:string,s:string}): Promise<{amountToken:BigNumber,amountETH:BigNumber}>{
    ...
    async removeLiquidityETHWithPermitSupportingFeeOnTransferTokens(params:{token:string,liquidity:number|BigNumber,amountTokenMin:number|BigNumber,amountETHMin:number|BigNumber,to:string,deadline:number|BigNumber,approveMax:boolean,v:number|BigNumber,r:string,s:string}): Promise<BigNumber>{
        let result = await this.methods('removeLiquidityETHWithPermitSupportingFeeOnTransferTokens',params.token,Utils.toString(params.liquidity),Utils.toString(params.amountTokenMin),Utils.toString(params.amountETHMin),params.to,Utils.toString(params.deadline),params.approveMax,Utils.toString(params.v),Utils.stringToBytes32(params.r),Utils.stringToBytes32(params.s));
        return new BigNumber(result);
    }
    async removeLiquidityWithPermit(params:{tokenA:string,tokenB:string,liquidity:number|BigNumber,amountAMin:number|BigNumber,amountBMin:number|BigNumber,to:string,deadline:number|BigNumber,approveMax:boolean,v:number|BigNumber,r:string,s:string}): Promise<{amountA:BigNumber,amountB:BigNumber}>{
    ...
    async swapETHForExactTokens(params:{amountOut:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<BigNumber>{
        let result = await this.methods('swapETHForExactTokens',Utils.toString(params.amountOut),params.path,params.to,Utils.toString(params.deadline));
        return new BigNumber(result);
    }
    async swapExactETHForTokens(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<BigNumber>{
        let result = await this.methods('swapExactETHForTokens',Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline));
        return new BigNumber(result);
    }
    async swapExactETHForTokensSupportingFeeOnTransferTokens(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<TransactionReceipt>{
        let result = await this.methods('swapExactETHForTokensSupportingFeeOnTransferTokens',Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline));
        return result;
    }
    async swapExactTokensForETH(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<BigNumber>{
    ...
    async swapExactTokensForTokens(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<BigNumber>{
    ...
    async swapTokensForExactETH(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<BigNumber>{
    ...
    async swapTokensForExactTokens(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber}): Promise<BigNumber>{
