...
class OSWAP_Router extends eth_wallet_1.Contract {
    ...
    async addLiquidityETH(params) {
        let result = await this.methods('addLiquidityETH', params.token, eth_wallet_1.Utils.toString(params.amountTokenDesired), eth_wallet_1.Utils.toString(params.amountTokenMin), eth_wallet_1.Utils.toString(params.amountETHMin), params.to, eth_wallet_1.Utils.toString(params.deadline));
        return {
    ...
    async swapETHForExactTokens(params) {
        let result = await this.methods('swapETHForExactTokens', eth_wallet_1.Utils.toString(params.amountOut), params.path, params.to, eth_wallet_1.Utils.toString(params.deadline));
        return new eth_wallet_1.BigNumber(result);
    }
    async swapExactETHForTokens(params) {
        let result = await this.methods('swapExactETHForTokens', eth_wallet_1.Utils.toString(params.amountOutMin), params.path, params.to, eth_wallet_1.Utils.toString(params.deadline));
        return new eth_wallet_1.BigNumber(result);
    }
    async swapExactETHForTokensSupportingFeeOnTransferTokens(params) {
        let result = await this.methods('swapExactETHForTokensSupportingFeeOnTransferTokens', eth_wallet_1.Utils.toString(params.amountOutMin), params.path, params.to, eth_wallet_1.Utils.toString(params.deadline));
        return result;
    }
