...
class OSWAP_Pair extends eth_contract_1.Contract {
    ...
    assign() {
        let EIP712_TYPEHASH_call = async () => {
        ...
        let updateFee_send = async () => {
            let result = await this.send('updateFee');
            return result;
        };
        let updateFee_call = async () => {
        ...
        let updateProtocolFee_send = async () => {
            let result = await this.send('updateProtocolFee');
            return result;
        };
        let updateProtocolFee_call = async () => {
