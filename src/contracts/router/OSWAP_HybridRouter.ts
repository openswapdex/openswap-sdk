...
export class OSWAP_HybridRouter extends Contract{
    ...
    async swapETHForExactTokens(params:{amountOut:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[],data:string}): Promise<BigNumber>{
        let result = await this.methods('swapETHForExactTokens',Utils.toString(params.amountOut),params.path,params.to,Utils.toString(params.deadline),params.pair,Utils.toString(params.fee),params.data);
        return new BigNumber(result);
    }
    async swapExactETHForTokens(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[],data:string}): Promise<BigNumber>{
        let result = await this.methods('swapExactETHForTokens',Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.pair,Utils.toString(params.fee),params.data);
        return new BigNumber(result);
    }
    async swapExactETHForTokensSupportingFeeOnTransferTokens(params:{amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[]}): Promise<TransactionReceipt>{
        let result = await this.methods('swapExactETHForTokensSupportingFeeOnTransferTokens',Utils.toString(params.amountOutMin),params.path,params.to,Utils.toString(params.deadline),params.pair,Utils.toString(params.fee));
        return result;
    }
    async swapExactTokensForETH(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[],data:string}): Promise<BigNumber>{
    ...
    async swapExactTokensForTokens(params:{amountIn:number|BigNumber,amountOutMin:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[],data:string}): Promise<BigNumber>{
    ...
    async swapTokensForExactETH(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[],data:string}): Promise<BigNumber>{
    ...
    async swapTokensForExactTokens(params:{amountOut:number|BigNumber,amountInMax:number|BigNumber,path:string[],to:string,deadline:number|BigNumber,pair:string[],fee:number[]|BigNumber[],data:string}): Promise<BigNumber>{
