...
export class TestERC20 extends _Contract{
    ...
    deploy(params: IDeployParams, options?: TransactionOptions): Promise<string>{
        return this.__deploy([params.symbol,params.name,this.wallet.utils.toString(params.initialSupply),this.wallet.utils.toString(params.cap),this.wallet.utils.toString(params.decimals)], options);
    }
