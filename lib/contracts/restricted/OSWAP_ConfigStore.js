...
class OSWAP_ConfigStore extends eth_wallet_1.Contract {
    ...
    async customParam(param1) {
        let result = await this.methods('customParam', eth_wallet_1.Utils.stringToBytes32(param1));
        return result;
    }
    async customParamNames(param1) {
        let result = await this.methods('customParamNames', eth_wallet_1.Utils.toString(param1));
        return result;
    }
    async customParamNamesIdx(param1) {
        let result = await this.methods('customParamNamesIdx', eth_wallet_1.Utils.stringToBytes32(param1));
