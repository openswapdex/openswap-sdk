...
export interface ISetPriceParams {token0:string;token1:string;price0:number|BigNumber;price1:number|BigNumber}
export class MockOracleAdaptor extends _Contract{
    ...
    private assign(){
        ...
        this.weth = weth_call
        let setPriceParams = (params: ISetPriceParams) => [params.token0,params.token1,this.wallet.utils.toString(params.price0),this.wallet.utils.toString(params.price1)];
