...
exports.deploy = exports.toDeployment = exports.DefaultGovTokenOptions = exports.DefaultGovOptions = void 0;
...
function toDeployment(wallet, result) {
    return {
        openSwap: new OpenSwap_1.OpenSwap(wallet, result.oswap),
        governance: new OAXDEX_Governance_1.OAXDEX_Governance(wallet, result.governance),
        administrator: new OAXDEX_Administrator_1.OAXDEX_Administrator(wallet, result.administrator),
        registry: new OAXDEX_VotingRegistry_1.OAXDEX_VotingRegistry(wallet, result.votingRegistry),
        pairCreator: new OSWAP_PairCreator_1.OSWAP_PairCreator(wallet, result.pairCreator),
        factory: new OSWAP_Factory_1.OSWAP_Factory(wallet, result.factory),
        oraclePairCreator: new OSWAP_OraclePairCreator_1.OSWAP_OraclePairCreator(wallet, result.oraclePairCreator),
        router: new OSWAP_Router_1.OSWAP_Router(wallet, result.router),
        oracleFactory: new OSWAP_OracleFactory_1.OSWAP_OracleFactory(wallet, result.oracleFactory),
        oracleRouter: new OSWAP_OracleRouter_1.OSWAP_OracleRouter(wallet, result.oracleRouter),
        oracleLiquidityProvider: new OSWAP_OracleLiquidityProvider_1.OSWAP_OracleLiquidityProvider(wallet, result.oracleLiquidityProvider),
        hybridRouterRegistry: new OSWAP_HybridRouterRegistry_1.OSWAP_HybridRouterRegistry(wallet, result.hybridRouterRegistry),
        hybridRouter: new OSWAP_HybridRouter2_1.OSWAP_HybridRouter2(wallet, result.hybridRouter),
        executor: new OAXDEX_VotingExecutor_1.OAXDEX_VotingExecutor(wallet, result.votingExecutor),
        executor1: new OSWAP_VotingExecutor1_1.OSWAP_VotingExecutor1(wallet, result.votingExecutor1),
        executor2: new OSWAP_VotingExecutor2_1.OSWAP_VotingExecutor2(wallet, result.votingExecutor2)
    };
}
