...
class OSWAP_OraclePair extends eth_contract_1.Contract {
    ...
    assign() {
        ...
        let delegator_call = async (param1) => {
        ...
        let findPosition_call = async (params) => {
        ...
        let getQueue_call = async (params) => {
        ...
        let getQueueFromIndex_call = async (params) => {
        ...
        let pauseOffer_send = async (params) => {
            let result = await this.send('pauseOffer', pauseOfferParams(params));
            return result;
        };
        let pauseOffer_call = async (params) => {
        ...
        let purgeExpire_send = async (params) => {
            let result = await this.send('purgeExpire', purgeExpireParams(params));
            return result;
        };
        let purgeExpire_call = async (params) => {
        ...
        let replenish_send = async (params) => {
            let result = await this.send('replenish', replenishParams(params));
            return result;
        };
        let replenish_call = async (params) => {
        ...
        let resumeOffer_send = async (params) => {
            let result = await this.send('resumeOffer', resumeOfferParams(params));
            return result;
        };
        let resumeOffer_call = async (params) => {
        ...
        let setDelegator_send = async (params) => {
            let result = await this.send('setDelegator', setDelegatorParams(params));
            return result;
        };
        let setDelegator_call = async (params) => {
        ...
        let setPrivateReplenish_send = async (replenish) => {
            let result = await this.send('setPrivateReplenish', [replenish]);
            return result;
        };
        let setPrivateReplenish_call = async (replenish) => {
