...
class OAXDEX_Governance extends eth_contract_1.Contract {
    ...
    assign() {
        ...
        let freezedStake_call = async (param1) => {
        ...
        let setMinStakePeriod_send = async (minStakePeriod) => {
            let result = await this.send('setMinStakePeriod', [this.wallet.utils.toString(minStakePeriod)]);
            return result;
        };
        let setMinStakePeriod_call = async (minStakePeriod) => {
        ...
        let unlockStake_send = async () => {
            let result = await this.send('unlockStake');
            return result;
        };
        let unlockStake_call = async () => {
