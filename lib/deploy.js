...
exports.deploy = exports.deployRestrictedPairOracle = exports.deployHybridRouter = exports.deployRestrictedContracts = exports.deployRangeContracts = exports.deployOracleContracts = exports.deployCoreContracts = exports.toDeploymentContracts = exports.DefaultGovTokenOptions = exports.DefaultGovOptions = void 0;
...
function deploy(wallet, options) {
    ...
    return new Promise(async function (resolve, reject) {
        try {
            ...
            let result = Object.assign(Object.assign(Object.assign({}, coreContractsResult), oracleContractsResult), hybridRouterResult);
            if (options.range) {
